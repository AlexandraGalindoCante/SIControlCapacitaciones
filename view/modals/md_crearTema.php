<div class="modal fade" aria-labelledby="myModalLabel"  id="crearTema" name="crearTema" role="dialog" tabindex="-1">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
          <h4 align="center" class="modal-title" id="myModalLabel">Crear tema</h4>
      </div>
      ...
      <div class="modal-body">
        <div id="datos_ajax">
          <?php
            ...
            $mysql->close();
          ?>
          <form id="crearTema" action="../controller/controladorTema.php" method="post" name="crearTema">
