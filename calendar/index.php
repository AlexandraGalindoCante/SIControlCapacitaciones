...
$sql = "SELECT idProgramacion,fechaInicio,fechaFin,modalidad,nivel,color FROM programacion ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Calendario programaciones</h1>
                <?php echo $event['nivel']; ?>                
                <p class="lead">........................</p>
        ...
        <!-- /.row -->
         <div class="modal fade" id="crearProgramacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document" style="padding-top: 15px; padding-bottom: 100px; padding:10px;">
		  	 <div class="modal-dialog" role="document">
			<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">Programar capacitación</h4>
			  </div>
			...
			<form  method="POST" id="crearProgramacion" name="crearProgramacion" action="../../controller/controladorProgramacion.php">
			 <div class="form-group">
			  ...
			  <div class="modal-footer">
				...
				<button type="submit" class="btn btn-success" name="funcion" id="funcion" value="0">Guardar cambios</button>
			  </div>
			</form>
		</div>
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="editEventTitle.php">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">Editar programación</h4>
			  </div>
			  <div class="modal-body">
    ...
    <script src='js/es.js'></script> <!-- Pasa el calendario a español -->
			...
			?>
				{
					...
					capacitacion: '<?php echo $event['tipoCapacitacion']; ?>',
					start: '<?php echo $start; ?>',
					end: '<?php echo $end; ?>',
					modalidad: '<?php echo $event['modalidad']; ?>',
					nivel: '<?php echo $event['nivel']; ?>',
